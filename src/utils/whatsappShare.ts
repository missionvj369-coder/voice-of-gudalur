/**
 * VoiceOfGudalur Community WhatsApp & SMS Broadcast Utility
...
export const generateWhatsAppAlertText = (alert: ShareAlertPayload): string => {
  ...
  return `🚨 *[VOICE OF GUDALUR - EMERGENCY ALERT / அவசர எச்சரிக்கை]* 🚨
━━━━━━━━━━━━━━━━━━━━
📌 *${alert.title}*
...
export const generateWhatsAppPetitionText = (petition: SharePetitionPayload): string => {
  return `📢 *[VOICE OF GUDALUR - CITIZEN ACTION / மக்கள் கோரிக்கை]*
━━━━━━━━━━━━━━━━━━━━
🗳️ *${petition.title}*
...
export const generateWhatsAppCivicIssueText = (issue: ShareCivicIssuePayload): string => {
  return `🛠️ *[VOICE OF GUDALUR - CIVIC ISSUE TRACKER]*
━━━━━━━━━━━━━━━━━━━━
📌 *Ticket ID:* ${issue.id}
...
_Check full Nilgiris & interstate timetable on VoiceOfGudalur_`;
};
