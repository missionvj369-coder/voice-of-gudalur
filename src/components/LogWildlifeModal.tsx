...
export const LogWildlifeModal: React.FC<LogWildlifeModalProps> = ({ isOpen, onClose, onLogged }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const localList = JSON.parse(localStorage.getItem('VoiceOfGudalur_wildlife_logs') || '[]');
    localList.unshift(incident);
    localStorage.setItem('VoiceOfGudalur_wildlife_logs', JSON.stringify(localList));
