      ...
      <div className="rounded-3xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-teal-50 p-3 space-y-2">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-bold text-emerald-600 uppercase tracking-wide">updating</span>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {mediaItems.slice(0, 9).map((m) => (
              <button
                ...
                type="button"
                onClick={() => {
                  // Poster/video tapped → open the fullscreen viewer DIRECTLY.
                  // No intermediate share page.
                  setViewingMedia(m);
              ...
              >
                {m.kind === 'poster' ? (
                  /* 4:5 poster ï¿½ object-contain keeps the full image + headline visible */
                ...
                <div className="absolute top-2 right-2 flex items-center gap-1.5">
                  <button
                    ...
                    className="p-1.5 rounded-lg bg-emerald-600/90 text-white backdrop-blur hover:bg-emerald-500 transition"
                    title={t("media.share")}
