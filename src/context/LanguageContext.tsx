...
const extraTranslations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'home.need_register': 'You must register (get a Gudalur ID) before signing — it takes 20 seconds.',
    ...
    'reg.subtitle': 'Just your name, mobile number and place — one number, one registration.',
    'reg.login_cta': 'Already registered? Login here',
    'reg.name': 'Full Name',
    'reg.phone': 'Mobile Number',
    'reg.place': 'Your Place (Gudalur & Nilgiris)',
    'reg.place_placeholder': 'Type your area name...',
  ...
  ta: {
    ...
    'home.need_register': 'கையெழுத்திடுவதற்கு முன் பதிவு செய்ய வேண்டும் (கூடலூர் ஐடி) — 20 வினாடிகளில் முடியும்.',
    ...
    'reg.subtitle': 'பெயர், கைபேசி எண் மற்றும் இடம் மட்டும் போதும் — ஒரு எண், ஒரே பதிவு.',
    ...
    'reg.place_placeholder': 'உங்கள் பகுதியின் பெயரை தட்டச்சு செய்க...',
